...
start_time_entry.insert(0, "730")  # Устанавливаем значение по умолчанию на "730" - 2 года
...
end_time_entry.insert(0, "0")  # Устанавливаем значение по умолчанию на "0", чтобы получить самые последние данные
